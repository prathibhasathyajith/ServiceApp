 ...
 * @author prathibha_s
 */
public class ConfigDataInputBean {
    ...
    Map<String, String> nameListVal = new LinkedHashMap<String, String>();
    ...
    public Map<String, String> getNameListVal() {
        return nameListVal;
    }

    public void setNameListVal(Map<String, String> nameListVal) {
        this.nameListVal = nameListVal;
    }
